...
export BASE_MODEL='/mnt/codefuse/438262/models/Qwen/Qwen2.5-1.5B-Instruct'
export PROJECT_NAME='hotpotqa_qwen2.5-1.5b-instruct'
export EXPERIMENT_NAME=grpo
export HYDRA_FULL_ERROR=1
export CUDA_LAUNCH_BLOCKING=1

MODEL_PATH=/mnt/nas/user/models/  # replace it with your local file path
MODEL_NAME=Qwen/Qwen2.5-VL-7B-Instruct
DATASET_PATH=/mnt/codefuse/438262/datasets/lmms-lab/
NAS_DATASET_PATH=<NAS_DATASET_PATH>
