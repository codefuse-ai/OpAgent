...
def main() -> None:
    ...
    input_path = os.environ.get("CONFIG_INPUT_PATH", "./config_files/wa/")
    output_path = os.environ.get("CONFIG_OUTPUT_PATH", "./config_files/wa_processed/")
    if DATASET == "webarena":
    ...
    for inp_path in inp_paths:
        filename = os.path.basename(inp_path).replace('.raw.json', '')
